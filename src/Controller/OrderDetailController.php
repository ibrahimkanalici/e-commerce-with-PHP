...
class OrderDetailController extends AbstractController
{
     ...
     */
    public function index(OrderDetailRepository $orderDetailRepository,CategoryRepository $categoryRepository): Response
    {
        $cats[0] = '<ul id = "menu-v"';
     ...
     */
    public function show(OrderDetail $orderDetail,CategoryRepository $categoryRepository): Response
    {
        $cats[0] = '<ul id = "menu-v"';
